Visão Geral Action Cable 
=====================
Neste guia você aprenderá como Action Cable funcionam e como utilizar WebSockets para incorporar funcionalidades em tempo real a sua aplicação Rails.

Após ler este guia, você saberá:

* O que é Action Cable e sua integração com o back-end e fron-end 
* Como configurar o Action Cable
* Como configurar os Channels
